module.exports = {
  ...
  getPixelRatio: function getPixelRatio(context) {
    console.log("Determining Pixel Ratio Moimagically.");
    var backingStores = [
  ...
  generateCanvas: function generateCanvas(w, h) {
    console.log("Generating Canvas Moimagically.");
    ...
    canvas.style.width = canvas.width / 16 + "rem";
    canvas.style.height = canvas.height / 16 + "rem";
